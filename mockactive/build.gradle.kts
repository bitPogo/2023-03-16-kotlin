    ...
    sourceSets {
        ...
        val commonTest by getting {
            ...
            dependencies {
                ...
                implementation(libs.mockactive.runtime)
            }
        }
...
dependencies {
    add("kspJvmTest", libs.mockactive.processor.get())
    add("kspAndroidTest", libs.mockactive.processor.get())
    add("kspJsTest", libs.mockactive.processor.get())
    add("kspIosX64Test", libs.mockactive.processor.get())
    add("kspIosSimulatorArm64Test", libs.mockactive.processor.get())
}
